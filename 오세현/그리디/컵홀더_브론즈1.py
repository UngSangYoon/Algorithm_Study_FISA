...
n = int(input())
seats = input().strip()  # 좌석 정보 문자열로 입력받기

# 커플석이 몇 번 등장하는지 세기
couple_cnt = seats.count('LL')

# 컵홀더의 개수 = (좌석 수 + 1) - 커플석의 개수
cup_holders = (n + 1) - couple_cnt

# 최종적으로 컵홀더를 이용할 수 있는 사람의 최대 수
# 사람 수 or 컵홀더 수 중 작은 값을 출력하기
